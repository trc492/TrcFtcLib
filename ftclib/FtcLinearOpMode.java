...
public abstract class FtcLinearOpMode extends OpMode
{
  ...
  protected final Object     runningNotifier = new Object();

  //------------------------------------------------------------------------------------------------
  // Construction
  //------------------------------------------------------------------------------------------------

  public FtcLinearOpMode() {
  }
  ...
  protected class LinearOpModeHelper implements Runnable {
    ...
    public void run() {
      ThreadPool.logThreadLifeCycle("LinearOpMode main", new Runnable() { @Override public void run() {
        ...
        try {
          FtcLinearOpMode.this.runOpMode();
